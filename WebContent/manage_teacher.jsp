...
if (session.getAttribute("name") == null) {
	session.setAttribute("frompage", "/futurestar/manage_teacher.jsp");
...
姓名：<input id="text_teacher_name" type="text" value="张三" />
手机号：<input id="text_teacher_mobilenum" type="text" value="13888888888" />
所属学校：<input id="text_teacher_schoolname" type="text" value="南京一中" />
